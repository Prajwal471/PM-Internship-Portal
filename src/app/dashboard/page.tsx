            ...
            <div className="space-y-3 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row sm:justify-center">
              {!user?.profileCompleted && (
                <button
                  ...
                  className="bg-orange-600 text-white px-4 py-2 rounded-md hover:bg-orange-700 text-sm font-medium w-full sm:w-auto"
                >
                  {t.completeProfile}
                </button>
              )}
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="text-right">
                      <div className="text-xl font-bold text-orange-600">₹{rec.stipend.toLocaleString()}</div>
                  ...
                  <div className="flex space-x-3">
                    <button className="flex-1 bg-orange-600 text-white py-2 px-4 rounded-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 font-medium text-sm">
                      {t.applyNow}
                    </button>
                    <Link href={`/internship/${rec.id}`} className="px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 text-sm">
                      {t.learnMore}
                    </Link>
                  </div>
                </div>
